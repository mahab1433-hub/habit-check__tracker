...
function EntranceScreen({ onEnter }: EntranceScreenProps) {
  ...
  return (
    <div className={`entrance-screen ${isExiting ? 'exit' : ''}`}>
      ...
      <div className="entrance-content-scroll">
        <div className="entrance-title-section">
